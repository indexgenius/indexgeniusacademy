        ...
        <section className="px-6 lg:px-20 py-24 bg-black relative border-b border-white/5 overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto text-center relative z-10">
                <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: false }}>
                    ...
                    <h3 className="text-3xl lg:text-5xl font-black italic tracking-tighter uppercase mb-8">NUESTRA <span className="text-red-600">MISIÓN</span></h3>
                    <p className="text-gray-300 font-bold uppercase tracking-widest text-sm lg:text-base leading-loose italic">
